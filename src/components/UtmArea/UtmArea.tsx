 ...
 * @group Components
 */
export const UtmArea = forwardRef<CRS, PropsWithChildren<UtmAreaProps>>(
  (
    {
      crsInstance,
      utmZone,
    ...
    const crs = useMemo(() => {
      ...
      throw Error(
        'Either a UTM zone (string containing zone number + N/S for north/south hemisphere) or a CRS instance must be provided as props to the UtmArea component!',
      );
