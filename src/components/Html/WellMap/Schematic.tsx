...
export const Schematic = ({
  ...
  const tracks = useMemo(
    () =>
      wellboreIds
        ...
        .sort(
          (a, b) =>
            (a.wellboreId === selected ? Infinity : 0) -
              (b.wellboreId === selected ? Infinity : 0) || a.slot - b.slot,
        ),
  ...
  useEffect(() => {
    if (depthAxisRef.current) {
      ...
      depthAxisGroup
        .selectAll('.tick>line')
        .attr('stroke', styles.depthAxisColor);
    }
  }, [depthAxis, styles]);
  ...
  useEffect(() => {
    if (kickoffAxisRef.current) {
      ...
      kickoffAxisGroup
        ...
        .attr('stroke', styles.kickoffAxisColor);
    }
  }, [kickoffAxis, styles]);
          ...
          >
            {tracks.map(track => (
              <Track
                ...
                slot={track.slot}
                color={
                  (colorMap && colorMap[track.wellboreId]) || color || 'silver'
                }
