 ...
 * @group Contexts
 */
export const WellMapContext = createContext<UseBoundStore<StoreApi<WellMapState>>>(null!)
...
export const useWellMapState = () => {
  ...
  if (!context) throw Error('WellMapState can only be used by children of the WellMap component!')
  return context
}