...
export const FormationsStripe = ({
  ...
  const [formationStripeData, setFormationStripeData] =
    useState<FormationStripeData | null>(null);
  ...
  useEffect(() => {
    ...
    if (formationStripeData) {
      ...
      uniforms.textPointersCount.value =
        formationStripeData.text.textPointersCount;
      uniforms.textPointersOffset.value =
        formationStripeData.text.textPointersOffset;
    }
  ...
  useEffect(() => {}, [ribbonContext, uniforms, width]);
