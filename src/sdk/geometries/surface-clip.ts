...
// The pure grid maths lives in `surface-grid` (which must stay three-free for the
// inlined stack worker); it is re-exported here so its long-standing import path
// keeps working.
export {
  gridToGridTransform,
  surfaceGridToWorld,
